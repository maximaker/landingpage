...
export function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-card dark:bg-card/95 text-foreground dark:text-foreground">
          ...
          <div className="mt-12">
            ...
            <form onSubmit={handleSubscribe} className="mt-4 sm:flex sm:max-w-md">
              ...
              <input
                ...
                className="w-full min-w-0 appearance-none rounded-md border border-border bg-background px-4 py-2 text-base text-foreground placeholder-muted-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                placeholder="Enter your email"
              />
              <div className="mt-3 sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/20"
                >
                  Subscribe
                </button>
              </div>
