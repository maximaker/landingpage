                    ...
                    {item.children.map((child) => {
                      ...
                      return (
                        <Link
                          key={child.href}
                          href={child.href}
                          className={`flex items-center gap-3 px-4 py-2 text-sm rounded-md transition-colors ${isChildActive ? 'bg-primary/10 text-primary' : 'text-foreground hover:bg-muted'}`}
                        >
